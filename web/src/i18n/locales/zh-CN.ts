export default {
    ...
    fork: {
        oidc: {
            requestFailed: "OIDC 请求失败（{{status}}）",
            disconnectRequestFailed: "OIDC 断开失败（{{status}}）",
            statusReadFailed: "OIDC 状态读取失败",
            catalogReadFailed: "OIDC 模型目录读取失败",
            authorizationStartFailed: "OIDC 授权发起失败",
            invalidScope: "所选模型未获此 OAuth 客户端允许，请检查 Sub2API OAuth Client 的 allowed_llm_scopes。",
            authorizationFailed: "OIDC 授权失败，请重新选择模型后连接。",
            modelSyncFailed: "OIDC 模型同步失败",
            disconnectFailed: "OIDC 断开失败",
            sessionInvalid: "受管理渠道的授权已失效，请重新连接",
            connectedHint: "已连接，可使用受管理模型",
            disconnectedHint: "连接后可使用受管理模型",
            changeModels: "更换模型",
            disconnectProvider: "断开 {{name}}",
            reconnectProvider: "重新连接 {{name}}",
            connectProvider: "连接 {{name}}",
            selectProviderModels: "选择 {{name}} 模型",
            authorize: "授权连接",
        },
        sub2api: {
            invalidLink: "Sub2API 授权链接无效",
            noModels: "Sub2API 未返回可用模型",
            defaultUnavailable: "默认模型不可用",
            verifying: "正在验证渠道授权...",
            failed: "授权失败",
            retryHint: "无法验证渠道授权，请返回来源页面重新发起。",
            authorizeConnection: "授权连接",
            useApiKey: "使用 API Key",
            oidcConnection: "OIDC",
            apiKeyConnection: "API Key",
            notConnected: "未连接",
            oidcUnavailable: "当前部署未启用 OIDC 授权，可直接使用长期 API Key。",
            disconnect: "断开",
            disconnected: "Sub2API 已断开",
            apiKeyTitle: "使用 Sub2API API Key",
            apiKeyPlaceholder: "输入长期有效的 API Key",
            verifyApiKey: "验证并读取模型",
            apiKeyRequired: "请输入 API Key",
            apiKeyVerificationFailed: "API Key 验证失败，请检查 Key 是否有效。",
            availableModels: "可用模型",
            selectedModelCount: "已选择 {{selected}} / {{total}}",
            selectAtLeastOneModel: "至少选择一个模型",
            saveApiKey: "保存并连接",
            apiKeyConnected: "Sub2API API Key 已连接",
            connectionSwitchFailed: "切换 Sub2API 连接失败，原连接保持不变。",
        },
        video: {
            xaiReferencesUnsupported: "xAI 视频接口暂不支持参考视频或参考音频，请移除这些参考资产",
            xaiNoTaskId: "xAI 视频接口没有返回任务 ID",
            xaiTaskCreateFailed: "xAI 视频任务创建失败",
            xaiGenerationExpired: "xAI 视频生成超时",
            xaiGenerationFailed: "xAI 视频生成失败",
            xaiTaskQueryFailed: "xAI 视频任务查询失败",
        },
    },
    settingsPanels: {
