export default {
    ...
    fork: {
        oidc: {
            ...
            invalidScope: "所选模型未获此 OAuth 客户端允许，请检查算力接入 OAuth Client 的 allowed_llm_scopes。",
        ...
        sub2api: {
            displayName: "算力接入",
            invalidLink: "算力接入授权链接无效",
            noModels: "算力接入未返回可用模型",
            ...
            disconnect: "断开",
            disconnected: "算力接入已断开",
            apiKeyTitle: "使用算力接入 API Key",
            ...
            saveApiKey: "保存并连接",
            apiKeyConnected: "算力接入 API Key 已连接",
            connectionSwitchFailed: "切换算力接入连接失败，原连接保持不变。",
        },
        video: {
