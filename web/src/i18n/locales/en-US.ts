export default {
    ...
    fork: {
        oidc: {
            requestFailed: "OIDC request failed ({{status}})",
            disconnectRequestFailed: "Failed to disconnect OIDC ({{status}})",
            statusReadFailed: "Failed to read OIDC status",
            catalogReadFailed: "Failed to load the OIDC model catalog",
            authorizationStartFailed: "Failed to start OIDC authorization",
            invalidScope: "The selected model is not allowed for this OAuth client. Check the Compute Access OAuth Client allowed_llm_scopes.",
            authorizationFailed: "OIDC authorization failed. Select the models and connect again.",
            modelSyncFailed: "Failed to synchronize OIDC models",
            disconnectFailed: "Failed to disconnect OIDC",
            sessionInvalid: "The managed provider authorization has expired. Connect again.",
            connectedHint: "Connected. Managed models are available.",
            disconnectedHint: "Connect to use managed models.",
            changeModels: "Change models",
            disconnectProvider: "Disconnect {{name}}",
            reconnectProvider: "Reconnect {{name}}",
            connectProvider: "Connect {{name}}",
            selectProviderModels: "Select {{name}} models",
            authorize: "Authorize and connect",
        },
        sub2api: {
            displayName: "Compute Access",
            invalidLink: "The Compute Access authorization link is invalid",
            noModels: "Compute Access did not return any available models",
            defaultUnavailable: "A default model is unavailable",
            verifying: "Verifying provider authorization...",
            failed: "Authorization failed",
            retryHint: "The provider authorization could not be verified. Return to the source page and start again.",
            authorizeConnection: "Authorize connection",
            useApiKey: "Use API Key",
            oidcConnection: "OIDC",
            apiKeyConnection: "API Key",
            notConnected: "Not connected",
            oidcUnavailable: "OIDC authorization is not enabled for this deployment. Use a long-lived API Key instead.",
            disconnect: "Disconnect",
            disconnected: "Compute Access disconnected",
            apiKeyTitle: "Use a Compute Access API Key",
            apiKeyPlaceholder: "Enter a long-lived API Key",
            verifyApiKey: "Verify and load models",
            apiKeyRequired: "Enter an API Key",
            apiKeyVerificationFailed: "API Key verification failed. Check that the key is valid.",
            availableModels: "Available models",
            selectedModelCount: "{{selected}} / {{total}} selected",
            selectAtLeastOneModel: "Select at least one model",
            saveApiKey: "Save and connect",
            apiKeyConnected: "Compute Access API Key connected",
            connectionSwitchFailed: "Could not switch the Compute Access connection. The current connection was kept.",
        },
        video: {
            xaiReferencesUnsupported: "The xAI video API does not support reference video or audio. Remove those reference assets.",
            xaiNoTaskId: "The xAI video API did not return a task ID",
            xaiTaskCreateFailed: "Failed to create xAI video task",
            xaiGenerationExpired: "xAI video generation timed out",
            xaiGenerationFailed: "xAI video generation failed",
            xaiTaskQueryFailed: "Failed to query xAI video task",
        },
    },
    settingsPanels: {
        ...
        video: { title: "Video settings", quality: "Quality", size: "Size", seconds: "Seconds", mode: "Mode", modes: { frames: "First & last frame", reference: "General reference", framesXai: "First frame", referenceXai: "Multi-image reference" }, resolution: "Resolution", ratio: "Aspect ratio", duration: "Duration", smart: "Smart", output: "Output", generateAudio: "Generate audio", watermark: "Add watermark", adaptive: "Adaptive", sizes: { landscape: "Landscape", portrait: "Portrait", square: "Square", widescreen: "Widescreen", tall: "Tall", auto: "Auto" }, ratios: { landscape: "Landscape", portrait: "Portrait", square: "Square", standardLandscape: "Standard landscape", standardPortrait: "Standard portrait", cinematic: "Cinematic", adaptive: "Adaptive" } },
