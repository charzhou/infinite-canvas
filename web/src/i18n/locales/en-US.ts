export default {
    ...
    fork: {
        oidc: {
            ...
            invalidScope: "The selected model is not allowed for this OAuth client. Check the Sub2API OAuth Client allowed_llm_scopes.",
        ...
        sub2api: {
            invalidLink: "The Sub2API authorization link is invalid",
            noModels: "Sub2API did not return any available models",
            ...
            disconnected: "Sub2API disconnected",
            apiKeyTitle: "Use a Sub2API API Key",
            ...
            apiKeyConnected: "Sub2API API Key connected",
            connectionSwitchFailed: "Could not switch the Sub2API connection. The current connection was kept.",
        },
        video: {
