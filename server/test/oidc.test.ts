...
const scopes = [
    ...
    "llm:openai:seedance-2.5",
    "llm:openai:seedance-2.0-mini",
    "llm:openai:minimax-h3",
    "llm:openai:gpt-5.6-terra",
].join(" ");
const modelIds = ["grok/grok-imagine-image", "grok/grok-imagine-image-quality", "grok/grok-imagine-video", "grok/grok-imagine-video-1.5", "openai/gpt-image-2", "openai/gpt-image-2.5-sunburst", "openai/gpt-image-2.5-flare", "openai/seedance-2.0", "openai/seedance-2.5", "openai/seedance-2.0-mini", "openai/minimax-h3", "openai/gpt-5.6-terra"];
